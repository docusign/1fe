...
export type PlatformUtils = {
     ...
     * @link https://github.docusignhq.com/pages/Core/1ds-docs/widgets/utils/widgets/
     */
...
export type PlatformPropsType = DeepReadonly<{
  /**
   * The environment the 1DS SHELL is running in.
   *
   * @link https://github.docusignhq.com/pages/Core/1ds-docs/ecosystem/deployment/environments/
   */
  environment: string;
  /**
  ...
  /**
   * Free utilities provided by the 1DS SHELL
   * All utilities are namespaced and unique to a widget loading inside the 1DS SHELL
   *
   * For a list of available utilities, see:
   * @link https://github.docusignhq.com/pages/Core/1ds-docs/widgets/utils/
   */
  utils: PlatformUtils;
  /**
   ...
   * will get those implementations rather than the ones provided by 1DS SHELL.
   */
