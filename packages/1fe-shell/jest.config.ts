  ...
  projects: [
    {
      ...
      transform: {
        ...
        '^.+\\.jsx?$': [
          'babel-jest',
          // babelrc needs to be set to false. Otherwise, Babel will merge the two configs which leads to errors in Jest.
          // See https://babeljs.io/docs/config-files#file-relative-configuration
          { configFile: './babel.jest.config.js', babelrc: false },
        ],
      },
      transformIgnorePatterns: [`/node_modules/(?!${esModules})`],
      setupFilesAfterEnv: ['./scripts/jestShellSetup.ts'],
      testEnvironment: 'jsdom',
      testMatch: [
