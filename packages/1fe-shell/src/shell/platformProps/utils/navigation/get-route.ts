 ...
 * e.g. on https://services.dev.docusign.net/1fe-app/v1.0/send/1234/abcd/asdf `getRoute` will return /1234/abcd/asdf
...
export const getRoute =
  ...
  (excludeQueryParams = false): Route => {
    ...
    // i.e. need to cover edge cases where the baseHrefUrl could be https://apps.docusign.com/ or https://apps.docusign.com/1fe-app/v1.0/ (<- technically deprecated but should still cover this edge case)
