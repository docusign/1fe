import { addQueryParamsToPath, generateCDNUrl, getBaseHrefUrl, reloadPage, stripTrailingSlash } from "../url";
...
describe('addQueryParamsToPath', () => {
  ...
  describe('generateCDNUrl', () => {
    it('should return the templatized URL', () => {
      ...
      expect(result.toString()).toEqual('https://someurl.com/test/widgetId/0.0.0/js/1ds-bundle.js');
    });
  });
